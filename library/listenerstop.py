...
if __name__ == '__main__':
    module = AnsibleModule(
        argument_spec=dict(
            ...
            state=dict(default="lsnrctlstop", choices=["lsnrctlstop"]),
    ...
    if state == 'lsnrctlstop':
        proc = subprocess.Popen(["$ORACLE_HOME/bin/srvctl stop listener"], stdout=subprocess.PIPE, shell=True)
